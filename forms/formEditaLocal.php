...
<html>
	...
	<body>
		...
		<?php
			include("../actions/carregaLocal.php");
		?>
		<div data-role="page" data-title="Editar Categoria" id="categoria">
			...
			<form method="get" action="../actions/editaLocal.php">

				<h2>Editar dados Atuais</h2>
				<input type="hidden" name="txtCodigo" id="txtCodigo" value="<?=$Local->locCodigo?>"></input>

				<div class="ui-field-contain">	
					<label  for="txtEstado">Estado</label>
					<input type="text" id="txtEstado" name="txtEstado"  placeholder="São Paulo" value="<?=$Local->locEstado?>" data-clear-btn="true" autocomplete="off">
				</div>

				<div class="ui-field-contain">	
					<label  for="txtMapa">Geo localização</label>
					<input type="text" id="txtMapa" name="txtMapa"  placeholder="" value="<?=$Local->locMapa?>" data-clear-btn="true" autocomplete="off">
				</div>
