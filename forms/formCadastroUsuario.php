...
<html>
	...
	<body>
		<div data-role="page" data-title="Cadastra Usuario" id="cadastro">
			...
			<form method="post" action="../actions/cadastraUsuario.php">

				<h2>Criar uma nova conta</h2>

				<div class="ui-field-contain">	
					<label  for="txtNick">NickName*</label>
					<input type="text" required id="txtNick" name="txtNick"  placeholder="Joao.js" value="" data-clear-btn="true" autocomplete="off">
				</div>

				<div class="ui-field-contain">	
					<label  for="txtEmail">E-mail*</label>
					<input type="email" required id="txtEmail" name="txtEmail"  placeholder="joao@email.com" value="" data-clear-btn="true" autocomplete="off">
				</div>
				...
				<div class="ui-field-contain">	
					...
					<input type="password" required id="txtConfirmaSenha" name="txtConfirmaSenha"  placeholder="**********" value="" data-clear-btn="true" autocomplete="off">
				</div>	
