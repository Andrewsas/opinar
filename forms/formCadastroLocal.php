...
<html>
	...
	<body>
		...
		<div data-role="page" data-title="Cadastra Categoria" id="categoria">
			...
			<form method="get" action="../actions/cadastraLocal.php">

				<h2>Criar uma nova categoria</h2>

				<div class="ui-field-contain">	
					<label  for="txtEstado">Estado</label>
					<input type="text" id="txtEstado" name="txtEstado"  placeholder="São Paulo" value="" data-clear-btn="true" autocomplete="off">
				</div>

				<div class="ui-field-contain">	
					<label  for="txtMapa">Geo localização</label>
					<input type="text" id="txtMapa" name="txtMapa"  placeholder="" value="" data-clear-btn="true" autocomplete="off">
				</div>
