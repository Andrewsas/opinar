...
<html>
	...
	<body>
		...
		<div data-role="page" data-title="Listar Categoria" id="categora">
			...
			<a href="formCadastroCategoria.php" style="float:right;"><button data-icon="plus" data-iconpos="notext">Adicionar</button></a>
			...
			<?php
				...
				if(isset($_GET["txtNome"])){
					$categoria->catNome=$_GET["txtNome"];			
				}else{
					$categoria->catNome= "";
				}
						...
						echo "
									<tr>
										...
										<div class='ui-grid-e center'>
											<a href='../forms/formEditaCategoria.php?txtCodigo=".$inseriu[$num]['CODIGO']."'><button style='float:left;' data-icon='refresh' data-iconpos='notext'>Atualizar</button></a>
											<a href='../actions/ativaCategoria.php?txtCodigo=".$inseriu[$num]['CODIGO']."'><button style='float:left;' data-icon='arrow-u' data-iconpos='notext'>Ativa</button></a>
											<a href='../actions/desativaCategoria.php?txtCodigo=".$inseriu[$num]['CODIGO']."'><button style='float:left;' data-icon='arrow-d' data-iconpos='notext'>Desativa</button></a>
											<a href='../actions/deletaCategoria.php?txtCodigo=".$inseriu[$num]['CODIGO']."'><button style='float:left;' data-icon='delete' data-iconpos='notext'>Deleta</button></a>
										<div>
										</td>
									</tr>";
						$num++;
