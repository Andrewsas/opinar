					...
					echo "<div data-role='dialog' id='sure' data-title='Atenção !!!' data-defaults='true'>
						  <div data-role='content'>
						    ...
						    <div class='ui-grid-solo'>
							    <a href='../forms/formListaItem.php' onClick='window.location.reload( true );' class='ui-block-a'  data-theme='b' data-role='button' data-theme='c'>Continuar</a>
						    </div>
						  </div>
						</div>";	
