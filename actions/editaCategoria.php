...
<html>
	...
	<body>
		<?php
			...
			$categoria->catImg=$_GET["txtImg"];
			
			$dao = new CategoriaDao();
			$inseriu = $dao->editaCategoria($categoria);
					...
					echo "<div data-role='dialog' id='sure' data-title='Atenção !!!' data-defaults='true'>
						  <div data-role='content'>
						    ...
						    <div class='ui-grid-a'>
							    ...
							    <a href='../forms/formListaCategoria.php' class='ui-block-b' data-role='button' data-theme='c'>Continuar</a>
						    </div>
						  </div>
						</div>";
					$num++;
